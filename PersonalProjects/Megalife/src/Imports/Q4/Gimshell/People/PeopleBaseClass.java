package Imports.Q4.Gimshell.People;

import java.util.Random;

public class PeopleBaseClass {
    //Maybe to solve the issue of not being able to cite or import different made files before, I could just paste them at the t=bottom here?
//we should intialize the arrays inside the array before; split the char array of characteristics with;
    //------------------------------------------------------------------------------------------------------------
    //HP and Stats(perks n shit) | Inventory and Equipment | Map, Navigation, and Quests | Misc Secrets | Settings
    //------------------------------------------------------------------------------------------------------------
    ...
    String status;      //need to make
    String ranking;     //need to make
    String perks;       //need to make - similar to specSkills?
    String specialSkills;
    String otherStatistics;   //need to make

//----------------------------------------------------------------------------------------------------------//
    public PeopleBaseClass(String name, String hp, String stamina,
                           String baseClass, String[] preferredElement,
                           String status, String ranking, String perks,
                           String specialSkills, String otherStatistics
    ){
    this.name=name;
    this.hp=hp;
...
//Very important Functions      -!TIME:2/26/2023.6:17PM!-
    ...
    public int staminaBarAmount(int[] debug){       //look at journal for guide or look at health function
