...
import Imports.*;
import Imports.Q4.Gimshell.People.PeopleBaseClass;
import java.util.Random;

//this file will be imported into Megalife.java, this will access a file in this directory that has all the stored value
//of people, houses, towns, weapons, and the rest of that junk and put them into classes made for them.

/*
String name, String hp, String stamina, String baseClass, String[] preferred Element,String status, String ranking, String perks, String specialSkills, String otherStatistics
^____ that is for the PeopleBaseClass creator for making npcs
 */

public class Q4Generation {

    public static void main(String[] args){
        String tempHp="";
        String tempStamina;
        String tempBaseClass;
        String[] tempPreferredElement;
        String tempStatus;
        String tempRanking;
        String[] tempPerks;
        String[] tempSpecialSkills;
        String[] tempOtherStatistics;

        //PeopleBaseClass baileyReynoldsNPCGimshell = new PeopleBaseClass("Bailey Reynolds", );
        ...
        //worldGeneration [like chest and stuff]
